...
public interface FoodOrderService {
     ...
     * @throws FoodItemException if there is an error retrieving food items associated with the orders.
     */
     ...
     * @return FoodOrderDto representing the retrieved food order.
     * @throws FoodOrderException if the specified food order is not found or if there is an error retrieving it.
     * @throws FoodItemException if there is an error retrieving food items associated with the order.
     */
     ...
     * @param updateFoodOrderDto Details of the updates to be applied to the food order.
     * @return FoodOrderDto representing the updated food order.
     * @throws FoodOrderException if the specified food order is not found or if there is an error updating it.
     * @throws FoodItemException if there is an error related to food items while updating the order.
     */
    FoodOrderDto updateFoodOrder(Long orderId, UpdateFoodOrderDto updateFoodOrderDto) throws FoodOrderException, FoodItemException;

    /**
     * Adds a food item to an existing food order.
     *
     * @param orderId The ID of the food order to which the item will be added.
     * @param foodItemId The ID of the food item to add.
     * @param quantity The quantity of the food item to add.
     * @return FoodOrderDto representing the updated food order after adding the item.
     ...
     *
     * @param orderId The ID of the food order from which the item will be deleted.
     * @param foodItemId The ID of the food item to delete from the order.
     * @throws FoodOrderException if the specified food order or food item is not found or if there is an error deleting the item.
     */
     ...
     * @throws FoodOrderException if the specified food order is not found or if there is an error deleting it.
     */
